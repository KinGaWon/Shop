...
public class KakaoPayController {
    ...
    private Map<String, Object> createKakaoPayRequest(Map<String, Object> paymentData, String userId, String partnerOrderId) {
        ...
        kakaoPayRequest.put("approval_url", "http://43.202.52.229:8080/controller/kakaoPay/success");
        kakaoPayRequest.put("cancel_url", "http://43.202.52.229:8080/controller/kakaoPay/cancel");
        kakaoPayRequest.put("fail_url", "http://43.202.52.229:8080/controller/kakaoPay/fail");
